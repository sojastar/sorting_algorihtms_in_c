...
RadixItem** format_input_data(size_t input_length,Data** input) {
  ...
  for (size_t i = 0; i < input_length; i++) {
    ...
    formated_entry->digits[0]   = hex_digit(input[i]->key,  0);
    formated_entry->digits[1]   = hex_digit(input[i]->key,  1);
    formated_entry->digits[2]   = hex_digit(input[i]->key,  2);
    formated_entry->digits[3]   = hex_digit(input[i]->key,  3);
    formated_entry->digits[4]   = hex_digit(input[i]->key,  4);
    formated_entry->digits[5]   = hex_digit(input[i]->key,  5);
    formated_entry->digits[6]   = hex_digit(input[i]->key,  6);
    formated_entry->digits[7]   = hex_digit(input[i]->key,  7);
    formated_entry->digits[8]   = hex_digit(input[i]->key,  8);
    formated_entry->digits[9]   = hex_digit(input[i]->key,  9);
    formated_entry->digits[10]  = hex_digit(input[i]->key, 10);
    formated_entry->digits[11]  = hex_digit(input[i]->key, 11);
    formated_entry->digits[12]  = hex_digit(input[i]->key, 12);
    formated_entry->digits[13]  = hex_digit(input[i]->key, 13);
    formated_entry->digits[14]  = hex_digit(input[i]->key, 14);
    formated_entry->digits[15]  = hex_digit(input[i]->key, 15);
